...
namespace Parser
{
    ...
    internal class TokenMachine
    {
        ...
        /// </summary>
        static readonly string[] KeyWords = { "int", "double","if","while","print","string","print" };
        /// <summary>
        /// enum that define what state the state machine is in
        /// </summary>
        enum states { inDigits, inWhitespace, inAlpha, inSymbol, inOperator, inInvalid,InString };
        /// <summary>
        ...
        public TokenMachine(string value)
        {
            ...
            KeyWordLookup = new Dictionary<string, Token.TokenType>()
            {
                ...
                {"string",Token.TokenType.TYPENAME},
                {"double",Token.TokenType.TYPENAME},
        ...
        void InString(char value)
        {
            ...
            value = chars.Dequeue();
            states newstate = GetState(value);
            AddTokenAndReset(Token.TokenType.STRING, newstate);
            inGeneric(value);
        }
